...
export const categories: Category[] = [
  {
    ...
    courses: [
      ...
      },
      {
        ...
        description: `宏观经济学是一门从社会总体进行效用优化的学科，笔者不能苟同传统的宏观-微观对立，两者的核心出发点都是最优化效用，在这一点上并无区别。无非是宏观更强调均衡的思想。事实上，消费、就业、增长等问题的前沿探索都将微观主体囊括其中。因此在了解了传统的ISLM分析后，转向动态的ADAS、DSGE、Solow模型，很有必要。这里附上笔者所整理的笔记（但缺少了Solow、Ramsey、内生增长），以及几份真题卷，其实与其纠结于中文的概念，不如掌握好几类模型的推导与演绎，但考试所限，总得回一点。`,
        resources: [
          {
            id: 'ma-1',
            title: "Reed's Notes",
            type: 'PDF',
            description: '宏观课堂笔记（含 IS-LM、ADAS、DSGE 框架）',
            downloadUrl: 'https://afyuxngkeyapjrncfxsz.supabase.co/storage/v1/object/public/Macroeconomics/Macroeconomics_book.pdf',
            downloadFilename: 'Macroeconomics_book.pdf',
            mimeType: 'application/pdf',
          },
          {
            id: 'ma-2',
            title: '2019 复旦宏观经济学真题（卷一）',
            type: 'PDF',
            description: '2019 年复旦经济学院宏经卷一，含选择与大题',
            downloadUrl: 'https://afyuxngkeyapjrncfxsz.supabase.co/storage/v1/object/public/Macroeconomics/2019_fudan.pdf',
            downloadFilename: '2019_fudan.pdf',
            mimeType: 'application/pdf',
          },
          {
            id: 'ma-3',
            title: '2019 复旦宏观经济学真题（卷二）',
            type: 'PDF',
            description: '2019 年复旦宏经卷二，偏分析题',
            downloadUrl: 'https://afyuxngkeyapjrncfxsz.supabase.co/storage/v1/object/public/Macroeconomics/2019_fudan_econ.pdf',
            downloadFilename: '2019_fudan_econ.pdf',
            mimeType: 'application/pdf',
          },
          {
            id: 'ma-4',
            title: 'Macroeconomics 考研题集',
            type: 'PDF',
            description: '口径较新的考研练习题，用于巩固模型推导',
            downloadUrl: 'https://afyuxngkeyapjrncfxsz.supabase.co/storage/v1/object/public/Macroeconomics/Some_exercise.pdf',
            downloadFilename: 'Some_exercise.pdf',
            mimeType: 'application/pdf',
          },
        ]
      },
    ...
    courses: [
      {
        ...
        description: '“大股灾里的叙事”项目以 2015 年中国股灾为自然实验，全文以 Markdown 展示在下方，欢迎直接阅读研究贡献、方法与实证。',
        contentMarkdown: narrativeCrashMarkdown,
        resources: []
      },
      {
