    ...
    courses: [
      {
        ...
        description: `“大股灾里的叙事”项目以 2015 年中国股灾为自然实验，结合 Shiller 叙事经济学与 Jiang-Kelly-Xiu 视觉资产定价范式，追踪公共媒体（官方叙事）与股民论坛（民间叙事）之间的传播裂痕。我们从 30,000+ 篇新华社与证券时报新闻、3,000,000+ 条股吧发言中提取情绪、恐慌与政策信号，构建能够解释塔西佗陷阱爆发的“叙事背离”因子，并将其与价格崩塌的时间点进行校准。
        
        数据与方法层面，项目自建 DeepSeek 驱动的叙事情绪打分体系，标注“救市—末日”两类情绪通道，并将价格-成交量序列转化为 CNN 可读的图像以复现 crash narrative。结果表明：当官方叙事延迟转向而民间 Narratives 急剧悲观时，模型提前 5–7 个交易日发出灾难信号；叙事因子与经典 CAPM/FF3 因子正交，为资产定价带来独立的 alpha。`,
        resources: [
          {
            id: 'ap-report',
            title: '大股灾里的叙事：研究全文',
            type: 'PDF',
            description: '完整论文（含方法、实证、附录）',
            downloadUrl: 'projects/narrative/narrative_crash_report.pdf',
            downloadFilename: 'narrative_crash_report.pdf',
            fileSize: 589004,
            mimeType: 'application/pdf',
            uploadedAt: '2024-12-11T00:00:00+08:00',
          },
          {
            id: 'ap-vis-data',
            title: 'Narrative Factor Visualization Data',
            type: 'CODE',
            description: '前端叙事指数与图像坐标 JSON',
            downloadUrl: 'projects/narrative/vis_data.json',
            downloadFilename: 'vis_data.json',
            fileSize: 68117,
          ...
          {
            id: 'ap-sentiment',
            title: '公共叙事情绪打分 (DeepSeek)',
            type: 'CODE',
            description: '新华社/证时报新闻逐条情绪标注 CSV',
            downloadUrl: 'projects/narrative/datasets/deepseek_sentiment_scores.csv',
            downloadFilename: 'deepseek_sentiment_scores.csv',
            fileSize: 4596106,
            mimeType: 'text/csv',
            uploadedAt: '2024-12-11T00:00:00+08:00',
          },
          {
            id: 'ap-treatment-fig',
            title: 'Narrative Crash 可视化（Treatment）',
            type: 'LINK',
            description: '股民叙事强化路径图（PNG）',
            downloadUrl: 'projects/narrative/figures/601766_treatment.png',
            downloadFilename: '601766_treatment.png',
            fileSize: 445,
            mimeType: 'image/png',
            uploadedAt: '2024-12-11T00:00:00+08:00',
          },
          {
            id: 'ap-control-fig',
            title: 'Narrative Crash 可视化（Control）',
            type: 'LINK',
            description: '官方叙事对照组图像（PNG）',
            downloadUrl: 'projects/narrative/figures/601766_control.png',
            downloadFilename: '601766_control.png',
            fileSize: 368,
            mimeType: 'image/png',
            uploadedAt: '2024-12-11T00:00:00+08:00',
          },
          {
            id: 'ap-comparison-fig',
            title: 'Narrative 背离对比 (A/B)',
            type: 'LINK',
            description: 'Treatment vs. Control 叙事裂痕图',
            downloadUrl: 'projects/narrative/figures/601766_comparison.png',
            downloadFilename: '601766_comparison.png',
            fileSize: 34405,
            mimeType: 'image/png',
            uploadedAt: '2024-12-11T00:00:00+08:00',
          },
