    ...
    courses: [
      {
        ...
        description: '政治经济学研究经济系统与政治制度之间的相互作用关系。课程涵盖资本主义、社会主义等不同经济体制的运作机制，以及国家政策对经济发展的影响。通过学习经典著作和当代理论，理解经济现象背后的政治逻辑。',
        resources: [
          { id: 'pe-1', title: '马克思《资本论》导读', type: 'PDF', description: '第一卷核心章节注释版' },
          { id: 'pe-2', title: '政治经济学原理讲义', type: 'PDF', description: '课堂笔记整理' },
          { id: 'pe-3', title: '期末复习思维导图', type: 'PDF', description: '知识点梳理' },
        ]
      },
      {
        id: 'microeconomics',
